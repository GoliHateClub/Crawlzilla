...
const (
	refreshToken = "Bearer+eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCIsInR5cGUiOiJSRUZSRVNIIn0.eyJhdWQiOlsic2hleXBvb3IiXSwiZXhwIjoxNzM4ODUzMTc2LCJpYXQiOjE3MzEwNzcxNzYsImlzcyI6InNoZXlwb29yIiwianRpIjoiZmE3YzlhZDItYTg3YS00ODJhLWJmODktZDc0MmFhNmJkODE0IiwibmJmIjoxNzMxMDc3MTc2LCJ1c2VySWQiOiI1NTUxMzc4NCJ9.KxgUdRZNvmAkmdirwKiZz5tHHgDX66aeFXtW3UHOpD0"
)
...
func MapAttributesToCrawlResult(attributes []AttributeData) ads.CrawlResult {
	...
	for _, attr := range attributes {
		...
		case "نوع ملک":
			result.PropertyType = attr.Value
		case "آسانسور":
...
func ExtractVillaForSale(ctx context.Context) (ads.CrawlResult, error) {
